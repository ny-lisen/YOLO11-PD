...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='runs/train/YOLO/exp_yolov11n2/weights/best.pt', help='trained weights path')
    ...
    parser.add_argument('--testtime', default=3000, type=int, help='test time')
